(function (global, factory) {
    ...
    Object.assign(FE.DEFAULTS, {
        imageManagerLoadURL: '/load-files',
    ...
    FE.PLUGINS.imageManager = function (editor) {
        ...
        function _loadImage(image) {
            ...
            img.onload = function () {
                ...
                if (image.url)
                    $img.attr('data-url', image.url); // Image tags.
        ...
        function _resizeModal(infinite_scroll) {
            ...
            if (!$modal.isVisible())
                return true; // If width changes, the number of columns may change.
        ...
        function _selectTag(e) {
            ...
            if (editor.opts.imageManagerToggleTags)
                $tag.siblings('a').removeClass('fr-selected-tag'); // Change displayed images.
        ...
        function _init() {
            if (!editor.$wp && editor.el.tagName !== 'IMG')
                return false;
        }
