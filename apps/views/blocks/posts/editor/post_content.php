...
<div id="edtabdesc" class="collapse show _drawer" data-parent="#edtabs" data-key="editor">
    <div class="form-group">
        <label class="sr-only" for="pEctst">Post Title</label>
        <input id="psttitle" name="title" type="text" class="form-control slugify form-field font-16 adtext" data-target="edt_slug" data-format="all" data-length="256" value="<?= isset($post["title"]) ? $post["title"] : ""; ?>" placeholder="Post title" aria-label="Post title" aria-describedby="basic-addon2">
    </div>
    <div class="form-group">
