...
/* * ************************************************************
 *  File: list.php
 *  Path: application/views/dashboard/pages/list.php
 *  Description: It's a list of pages for website.
 * 
 * Function Added:
 * 
 *  History:
...
<main class="main">
    <div class="container-fluid overview">
        <div class="main-title d-flex justify-content-between">
            <div class="main-title-name">
                <p class="font-16 text-uppercase mb-2 text-darkgray">Blog Pages</p>
                <?php breadcrumb(array("Pages" => "blog/pages")); ?>
            </div>
            <div class="button-date-container d-flex">
                <div class="create-button-container">
                    <a href="<?php url("pages/new") ?>" class="create-button btn">Create New Page</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row row-1 data-table-paginated">
        <div class="col col-12 card-shadow-1-data-table-paginated">
            <div class="table-container">
                <ul id="pages" class="posts list-group list-group-flush pointer _drawer" data-key="pagestable"></ul>
    ...
    <div id="pagelisthtml" class="hidden">
