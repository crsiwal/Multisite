    ...
    <div class="container-fluid overview">
        <div class="main-title d-flex justify-content-between">
            <div class="main-title-name">
                <p class="font-16 text-uppercase mb-2 text-darkgray">New Page</p>
                <?php breadcrumb(array("Pages" => "blog/pages", "New Page" => "pages/new")); ?>
            </div>
        </div>
    </div>
    <div class="row row-1">
