...
/* * ***********************************************************************
 *  File: adsize.php
 *  Path: application/views/dashboard/ads/adsize.php
    ...
    <div class="container-fluid setup-events">
        <div class="main-title d-flex justify-content-between">
            <div class="main-title-name">
                <p class="font-16 text-uppercase mb-2 text-darkgray">AdSize</p>
                <?php breadcrumb(array("Setup" => "setup", "AdSize" => "setup/adsize")); ?>
            </div>
            <div class="button-date-container d-flex">
                <div id="ads_crtbtn" class="create-button-container">
                    <button class="create-button btn">New AdSize</button>
                </div>
            </div>
        </div>
        <div class="row row-1 data-table-paginated">
            <div class="col col-12 card-shadow-1-data-table-paginated">
                <div class="table-container">
                    <table id="adstable" class="table _drawer" data-key="adstable">
                        <thead>
                    ...
                    <div class="data-table-actions d-flex justify-content-end">
                        <div class="data-table-actions-pagination">
                            <nav aria-label="Page navigation">
                                <ul id="adstablenav" class="pagination">
