...
/* * ***********************************************************************
 *  File: adgroup.php
 *  Path: application/views/dashboard/ads/adgroup.php
 *  Description: It's a adgroup page.
 * 
 *  History:
    ...
    <div class="container-fluid setup-events">
        <div class="main-title d-flex justify-content-between">
            <div class="main-title-name">
                <p class="font-16 text-uppercase mb-2 text-darkgray">AdGroup</p>
                <?php breadcrumb(array("Ads" => "blog/ads", "AdGroup" => "blog/adgroup")); ?>
            </div>
            <div class="button-date-container d-flex">
                <div id="adg_crtbtn" class="create-button-container">
                    <button class="create-button btn">New AdGroup</button>
                </div>
            </div>
        </div>
        <div class="row row-1 data-table-paginated">
            <div class="col col-12 card-shadow-1-data-table-paginated">
                <div class="table-container">
                    <table id="adgtable" class="table the-table _drawer" data-key="adgtable">
                        <thead>
                            <tr class="bg-lightgray">
                                <th scope="col" class="font-13 text-darkgray-5">Name</th>
                                <th scope="col" class="font-13 text-darkgray-5">Size</th>
                                <th scope="col" class="font-13 text-darkgray-5">Site Key</th>
                    ...
                    <div class="data-table-actions d-flex justify-content-end">
                        <div class="data-table-actions-pagination">
                            <nav aria-label="Page navigation">
                                <ul id="adgtablenav" class="pagination">
