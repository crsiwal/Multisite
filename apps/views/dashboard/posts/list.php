...
<main class="main">
    <div class="container-fluid overview">
        <div class="main-title d-flex justify-content-between">
            <div class="main-title-name">
                <p class="font-16 text-uppercase mb-2 text-darkgray">Blog Posts</p>
                <?php breadcrumb(array("Posts" => "blog/posts")); ?>
            </div>
            <div class="button-date-container d-flex">
                <div class="create-button-container">
                    <a href="<?php url("posts/new") ?>" class="create-button btn">Create New Post</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row row-1 data-table-paginated">
        <div class="col col-12 card-shadow-1-data-table-paginated">
            <div class="table-container">
                <ul id="posts" class="posts list-group list-group-flush pointer _drawer" data-key="poststable"></ul>
    ...
    <div id="postlisthtml" class="hidden">
